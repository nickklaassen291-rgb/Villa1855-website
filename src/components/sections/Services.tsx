      ...
      <div className="container">
        ...
        <div className="cards-grid">
          ...
          <div className="card">
            ...
            <h3>Bruiloften</h3>
            <p>Vier jullie liefde in een stijlvol decor vol karakter en elegantie. Van ceremonie tot feest, alles op één plek met exclusieve aandacht voor jullie dag.</p>
